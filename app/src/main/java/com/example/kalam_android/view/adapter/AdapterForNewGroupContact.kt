...
class AdapterForNewGroupContact(
    val context: Context,
    val onClickNewGroupContact: OnClickNewGroupContact
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        return if (viewType == VIEW_HEADER) {
            NewGroupNameViewHolder(
                DataBindingUtil.inflate(
                    LayoutInflater.from(parent.context),
                    R.layout.item_for_add_group_name,
                    parent,
                    false
                )
            )
        } else {
            NewGroupContactViewHolder(
                DataBindingUtil.inflate(
                    LayoutInflater.from(parent.context),
    ...
    inner class NewGroupNameViewHolder(val binding: ItemForAddGroupNameBinding) :
