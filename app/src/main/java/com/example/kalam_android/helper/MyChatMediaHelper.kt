...
class MyChatMediaHelper(
        ...
        Dexter.withActivity(context).withPermissions(
            ...
            override fun onPermissionsChecked(report: MultiplePermissionsReport?) {
                if (report!!.areAllPermissionsGranted()) {
                    view.lvForAttachment.visibility = View.GONE
                    view.lvForRecorder.visibility = View.VISIBLE
                } else {
    ...
    private fun initRecorderListener() {
        view.lvForRecorder.ivRecord.setOnClickListener(this)
        view.lvForRecorder.ivStop.setOnClickListener(this)
        view.lvForRecorder.ivPlay.setOnClickListener(this)
        if (isDialog) {

        } else {
            view.lvForRecorder.ivCancel.setOnClickListener(this)
        }
    }
    ...
    private fun updateDrawables(
        ...
        view.lvForRecorder.ivStop.setImageResource(stopButton)
    }
    ...
    private fun updateClickable(
        ...
        view.lvForRecorder.ivStop.isClickable = canClickStop
    }
    ...
    fun hideRecorder() {
        view.lvForRecorder.visibility = View.GONE
    }

    private fun visibility(recorderVisibility: Int, seekbarVisibility: Int, chronometer: Int) {

        view.lvForRecorder.visibility = recorderVisibility
        view.lvForRecorder.lvSeekBar.visibility = seekbarVisibility
        view.chronometer.visibility = chronometer
    }
        ...
        runnable = Runnable {
            try {
                if (mediaPlayer != null) {
                    ...
                    currentSeconds?.let {
                        view.lvForRecorder.seekBar.progress = it
                    }
    ...
    fun openAttachments() {
        ...
        if (isAttachmentOpen) {
            ...
            view.lvForRecorder.visibility = View.GONE
            view.lvForAttachment.visibility = View.VISIBLE
    ...
    private fun initAttachmentListeners() {
        view.lvForAttachment.llGallery.setOnClickListener(this)
    }
